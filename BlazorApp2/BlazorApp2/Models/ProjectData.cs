namespace BlazorApp2.Models
{
    ...
    public class ProjectData
    {
        ...
        public static readonly Dictionary<string, TextOnlyProjectData> textProjectsToDescriptions = new Dictionary<string, TextOnlyProjectData>
        {
            ...
            { "AlgorithExplorationMajorityVote", new TextOnlyProjectData{ DisplayName = "Majority Vote", Description= "Took on the implementation of the Majority Vote algorithm, participating in a friendly competition with peers to optimize runtime. Working on this project gave me a new appreciation of algorithms and efficient computation and resource utilization." } },
